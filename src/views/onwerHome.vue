...
<script>
// @ is an alias to /src
import Slider from '@/components/onwerSlider.vue'
...
export default {
    ...
    tabRemove (targetName) {
      ...
      if (this.activeIndex === targetName) {
        ...
        if (this.openTab && this.openTab.length >= 1) {
          ...
          this.$router.push({path: '/onwerInfo'})
        }
      }
    }
  },
  mounted () {
    ...
    if (this.$route.path !== '/onwerInfo' && this.$route.path !== '/onwerHome') {
      console.log('1')
      this.$store.commit('add_tabs', {route: '/onwerInfo', name: '个人信息'})
      ...
      console.log('2')
      this.$store.commit('add_tabs', {route: '/onwerInfo', name: '个人信息'})
      this.$store.commit('set_active_index', '/个人信息')
      // this.$router.push('/')
